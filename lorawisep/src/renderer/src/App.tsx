...
const App: React.FC = () => {
  ...
  const onFinish = async (values) => {
    console.log(values)
    setContext(values)
    const retorno = await window.electron.generateGraph(values)
      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            // rules={[{ required: true }]}
          >
            <Select placeholder="Selecione o ambiente da simulação" allowClear>
          ...
          <Form.Item
            ...
            // rules={[{ required: true }]}
          >
            <Select placeholder="Selecione o algoritmo" allowClear>
