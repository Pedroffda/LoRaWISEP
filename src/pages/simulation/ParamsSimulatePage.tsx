...
export function ParamsSimulatePage() {
  ...
  return (
    <MainLayout>
      ...
      <Button className="mt-10 w-2/3 bg-sky-200	" variant='outline'>
        Preencher automaticamente
      </Button>

      <Accordion type="single" collapsible className="mt-10 w-2/3" orientation="vertical">
      ...
      <Accordion type="single" collapsible className="mt-10 w-2/3">
        <AccordionItem value="item-1">
      ...
      <Button className="mt-10 w-2/3">
        Simular
      </Button>

      <Button className="mt-2 w-2/3" variant="outline">
        Limpar
      </Button>
